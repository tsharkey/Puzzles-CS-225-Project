...
public class MinerGUI extends JPanel implements MouseListener {
    ...
    public static ArrayList<boolean[]> undoList = new ArrayList<>();// the list is used for undo action
    public static ArrayList<Integer> timeList = new ArrayList<>();// save state of time of every movement
